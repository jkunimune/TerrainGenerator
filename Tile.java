...
// BIOME KEY: 0:Magma 1:Ocean 2:Ice 3:Tundra 4:Plains 5:Desert 6:Jungle 7:Mountain 8:Snowcap 9:Freshwater 10:Space 11:Star
  ...
  public void startPlate(boolean wet) { // becomes the seed for a continental plate
    ...
    temp2 = (int)(Math.random()*Math.PI); // randomizes drift velocity
    temp3 = (int)(Math.random()*2*Math.PI); // these numbers represent a vector, so they are coordinates representing a point on the axis of the plate's rotation, which also goes through the center of the sphere
  }
