...
/* Generate some quick spherical terrain and simulate civilizations on it */
/* by Justin Kunimune*/
public final class CiviHD { // the driver for my independent project
  ...
  public static final void main(String args[]) {
    ...
    Map topographical = new mapprojections.PierceQuincuncial(protoEarth.getSurface(), 500, 500);
